...
----------------------------------------
   ...
   * The following TCs were killed by exceeding their limit temperature: T1; T3; T5; and T6. After the limit is reached NaNs are inserted into the data as the measurements are not reliable anymore.

   * T2 very close to its limit and not behaving smoothly for the whole test duration. It may be unreliable and shall be taken with care.
