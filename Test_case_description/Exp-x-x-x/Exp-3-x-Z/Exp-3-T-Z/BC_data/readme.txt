...
Content description:
   ...
   * surface_recession.dat: Distance over time of the surface points from the center of the original hemispherical dome. The points are indicated as angular positions with 0 angle at the stagnation point and ~121° at the sample bottom.
   ...
   * pressure_distribution_part*.dat: Pressure distribution over the surface for the same angular positions as in surface_recession.dat, where * indicates the first or second test start.
