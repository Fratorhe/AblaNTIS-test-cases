...
Content description:
   ...
   * pressure_distribution_t*s.dat: Pressure distribution over the surface for the same angular positions as in surface_recession.dat, where * represents the test instant in seconds.
