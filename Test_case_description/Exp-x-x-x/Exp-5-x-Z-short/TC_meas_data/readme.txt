...
----------------------------------------
Notes for Exp-5-x-Z-short
----------------------------------------

   * The following TCs were killed by exceeding their limit temperature: T1. After the limit is reached NaNs are inserted into the data as the measurements are not reliable anymore.
